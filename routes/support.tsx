...
export const Route=createFileRoute("/support")({head: () => pageHead({path:'/support',title:'VOW - Get in touch',description:'Contact VOW for app support, feedback, partnerships, privacy requests or account deletion.'}),component:SupportPage});
...
function SupportPage(){
  ...
  function submit(e:FormEvent<HTMLFormElement>){
    ...
    const params=new URLSearchParams({subject:"VOW — "+reason,body});
