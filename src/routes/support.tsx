...
export const Route = createFileRoute("/support")({
  head: () => pageHead({
    path: "/support",
    title: "VOW - Get in touch",
    description: "Contact VOW for app support, feedback, partnerships, privacy requests or account deletion.",
  }),
          ...
          <div className="p-7 sm:p-10 lg:col-span-8 lg:p-12">
            ...
            <form onSubmit={submit} className="space-y-7">
              ...
              <div className="flex flex-wrap items-center gap-6 pt-2">
                ...
                <Link to="/terms-and-services" className="text-sm text-vow-muted underline underline-offset-4">Terms & Privacy</Link>
              </div>
            </form>
          </div>
        </div>
