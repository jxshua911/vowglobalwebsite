...
export const Route=createFileRoute("/legal")({
 head: () => pageHead({path:'/legal',title:'VOW - Privacy, terms & account deletion',description:'Privacy Policy, Terms of Use / EULA, copyright and account deletion information for the VOW goal-planning and accountability app.'}),
 component:Legal
});
