...
export const Route=createFileRoute("/assistant")({
  head: () => pageHead({path:'/assistant',title:'VOW - Assistant',description:'Ask the VOW assistant about the goal-planning app, support, privacy and how VOW works, or hand the conversation to a person.'}),
  component:Assistant,
});
