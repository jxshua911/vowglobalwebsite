...
<section className="bg-vow-bg text-vow-ink"><div className="container-site py-16 sm:py-20"><p className="vow-label !text-vow-muted">Need something specific?</p><h2 className="mt-3 max-w-3xl text-4xl sm:text-5xl">Tell us what you're trying to build.</h2><Link to="/support" className="vow-btn-ghost mt-8">Get in touch →</Link></div></section>
</>;}
