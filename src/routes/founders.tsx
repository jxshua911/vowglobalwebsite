    ...
    <>
      <section className="border-b border-vow-border bg-vow-bg">
        <div className="container-site py-20 sm:py-28">
          <p className="vow-label">The founder</p>
          <div className="mt-6 grid gap-12 lg:grid-cols-12 lg:items-end">
            <div className="lg:col-span-8">
              <h1 className="max-w-5xl text-[clamp(4rem,9vw,8rem)] leading-[.82] tracking-[-.045em]">Built by<br />Joshua.</h1>
            </div>
            <div className="lg:col-span-4">
              <p className="max-w-[34ch] text-lg leading-[1.75] text-vow-muted">VOW is a product built from a simple belief: having a goal is easy. Keeping your word to yourself is the harder part.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container-site py-16 sm:py-24">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-start">
          <div className="lg:col-span-6">
            <div className="relative aspect-[4/5] overflow-hidden bg-vow-surface border border-vow-border">
              <div className="absolute inset-0 flex items-end justify-between p-7 sm:p-9">
                ...
                <span className="vow-label">Photo coming soon</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 lg:col-start-8 lg:pt-2">
            ...
            <h2 className="mt-4 text-4xl leading-none sm:text-5xl">Founder of VOW.</h2>
      ...
      <section className="container-site py-20 sm:py-24">
        <div className="flex flex-col gap-8 border-t border-vow-border pt-8 md:flex-row md:items-end md:justify-between">
          <div><p className="vow-label">Want to talk?</p><h2 className="mt-4 text-[clamp(2.6rem,5vw,4.5rem)] leading-[.9]">Let's build something useful.</h2></div>
