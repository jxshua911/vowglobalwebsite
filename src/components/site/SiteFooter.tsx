    ...
    <div className="container-site py-14">
      <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr]">
        ...
        <nav><p className="vow-label">{sw?"Gundua":"Explore"}</p><ul className="mt-5 space-y-3 text-sm">
          <li><Link to="/how-it-works">How it works</Link></li><li><Link to="/work">Work</Link></li><li><Link to="/services">Services</Link></li><li><Link to="/support">{sw?"Wasiliana nasi":"Get in touch"}</Link></li>
        </ul></nav>
        <nav><p className="vow-label">{sw?"Sheria":"Legal"}</p><ul className="mt-5 space-y-3 text-sm">
          <li><Link to="/legal#privacy">{sw?"Faragha":"Privacy"} Policy</Link></li><li><Link to="/legal#terms">{sw?"Masharti":"Terms"} / EULA</Link></li><li><Link to="/legal#copyright">{sw?"Hakimiliki":"Copyright"} / DMCA</Link></li><li><Link to="/legal#account-deletion">Account deletion</Link></li>
        </ul></nav>
      </div>
